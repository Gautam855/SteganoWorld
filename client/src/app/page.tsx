...
import {
    ...
    Binary, MessageCircle, FileText, Flame
} from "lucide-react";
        ...
        <div className="min-h-screen bg-[#050505] text-white overflow-x-hidden select-none pb-20">
            ...
            <section className="relative min-h-screen flex flex-col items-center justify-center pt-20 overflow-hidden">
                ...
                >
                    ...
                    <h1 className="w-full flex justify-center items-center text-center text-7xl md:text-9xl lg:text-[13rem] font-black tracking-tighter leading-[0.75] mb-12 bg-clip-text text-transparent bg-gradient-to-b from-white via-neutral-100 to-neutral-500 drop-shadow-2xl">
                    ...
                    <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-6 px-4">
                        <Link href="/EncryptText" className="group relative w-full sm:w-auto">
                            ...
                            <div className="relative px-12 py-6 bg-emerald-500 text-white rounded-[24px] font-black text-xl flex items-center justify-center gap-3 transition-all hover:scale-[1.04] shadow-2xl overflow-hidden active:scale-95">
                        ...
                        <Link href="/chat" className="group relative w-full sm:w-auto">
                            <div className="absolute -inset-1 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-[28px] blur opacity-40 group-hover:opacity-100 transition duration-500" />
                            <div className="relative px-12 py-6 bg-indigo-600 text-white rounded-[24px] font-black text-xl flex items-center justify-center gap-3 transition-all hover:scale-[1.04] shadow-2xl overflow-hidden active:scale-95">
                                <MessageCircle size={24} className="group-hover:rotate-12 transition-transform" />
                                E2EE CHAT & LINKS
                            </div>
                        </Link>
                        <Link href="/DecryptText" className="group w-full sm:w-auto px-12 py-6 bg-white/[0.03] hover:bg-white/[0.08] text-white border border-white/10 rounded-[24px] font-black text-xl backdrop-blur-xl transition-all flex items-center justify-center gap-3 active:scale-95 shadow-2xl">
                            <Eye size={24} className="group-hover:scale-110 transition-transform" /> REVEAL
                        </Link>
                    </div>
                </motion.div>
            ...
            <section className="py-40 px-4 max-w-7xl mx-auto space-y-10">
                ...
                {/* Chat / Link Bento Add-on */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div className="relative p-16 rounded-[60px] bg-gradient-to-tr from-indigo-900/20 via-purple-900/10 to-transparent border border-white/[0.05] overflow-hidden group hover:border-indigo-500/50 transition-all">
                        <div className="relative z-10">
                            <MessageCircle size={48} className="text-indigo-400 mb-8 group-hover:scale-110 transition-transform" />
                            <h2 className="text-5xl font-black mb-6 tracking-tighter leading-none">ZERO-KNOWLEDGE <span className="text-indigo-400">CHAT</span></h2>
                            <p className="text-neutral-400 mb-10 font-medium leading-relaxed">Communicate using AES-256-GCM. We don't possess your keys. We can't read your messages. Drop Stegano-Images inline seamlessly.</p>
                            <Link href="/chat" className="inline-flex items-center gap-5 px-10 py-4 border border-indigo-500/50 text-indigo-300 rounded-[24px] font-bold text-sm tracking-widest uppercase hover:bg-indigo-500 hover:text-white transition-all">
                                ENTER SECURE COMMS <ArrowRight size={18} />
                            </Link>
                        </div>
                    </div>
                    <div className="relative p-16 rounded-[60px] bg-gradient-to-bl from-rose-900/20 via-orange-900/10 to-transparent border border-white/[0.05] overflow-hidden group hover:border-rose-500/50 transition-all">
                        <div className="relative z-10">
                            <Flame size={48} className="text-rose-400 mb-8 group-hover:scale-110 transition-transform" />
                            <h2 className="text-5xl font-black mb-6 tracking-tighter leading-none">EPHEMERAL <span className="text-rose-400">LINKS</span></h2>
                            <p className="text-neutral-400 mb-10 font-medium leading-relaxed">Share secure payloads via auto-destructing links. Set view-limits and watch the data permanently evaporate from our servers forever.</p>
                            <Link href="/guide" className="inline-flex items-center gap-5 px-10 py-4 bg-white/[0.05] hover:bg-white/10 text-rose-300 rounded-[24px] font-bold text-sm tracking-widest uppercase transition-all shadow-xl">
                                HOW IT WORKS <FileText size={18} />
                            </Link>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-12">
                        ...
                        <div className="flex flex-col items-center md:items-end gap-8">
                            ...
                            <div className="flex gap-10">
                                ...
                                <Link href="/guide" className="text-[11px] font-black uppercase tracking-[0.6em] text-neutral-600 hover:text-emerald-500 transition-colors">DOCS & GUIDE</Link>
                                <Link href="/chat" className="text-[11px] font-black uppercase tracking-[0.6em] text-neutral-600 hover:text-emerald-500 transition-colors">CHAT</Link>
                            </div>
                        </div>
                    </div>
